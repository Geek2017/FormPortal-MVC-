...
angular.module('newApp').controller('createstaffdCtrl', function($scope) {
    ...
    databaseRef.once('value', function(snapshot) {
        snapshot.forEach(function(childSnapshot) {
            ...
            if (localStorage.getItem('curusermail') == childData.cusemail) {
                localStorage.setItem('curuserid', childData.cusid);
                console.log(childData);
            } else if (localStorage.getItem('curuserid') == childData.cusid) {
                console.log(childData);

                var stafflist = JSON.stringify(childData);
    ...
    $scope.stafflists = [{
            contact: "09216686509",
            cusemail: "portalmanager@yopmail.com",
            cusid: "16640",
            cusname: "JMG",
